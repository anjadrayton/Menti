...
MentorshipApplication.create(user_id: 1, mentorship_id: 1, message: "please accept me", status: "pending")
MentorshipApplication.create(user_id: 3, mentorship_id: 1, message: "I want to get good", status: "accepted")
MentorshipApplication.create(user_id: 4, mentorship_id: 2, message: "let me learn from you!", status: "rejected")
